        ...
        <ul>
          <li><a href="#">Cadastrar</a>
            <ul>
              ...
              <li><a href="cad_agendamento.html">Agendamento</a></li>
              <li><a href="cad_orcamento.html">Orçamentos</a></li>
            </ul>
          </li>
          <li><a href="">Listar</a>
            <ul>
              <li><a href="listar_clientes.php">Clientes</a></li>
              <li><a href="listar_agendamentos.php">Agendamentos</a></li>
              <li><a href="listar_orcamentos.php">Orçamentos</a></li>
              <li><a href="listar_admin.php">Administradores</a></li>
            </ul>
          </li>
